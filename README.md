...
Un jeu de course sur 3 voies en **pseudo-3D**, codé en Python avec Pygame, dans un décor de jour coloré (ciel dégradé, ville, trains multicolores). Le coureur est vu de dos. Il faut esquiver les trains, sauter les barrières basses et glisser sous les portiques, tout en ramassant pièces et bonus. La vitesse augmente au fil de la partie.
...
Trois missions par palier (ex. « Ramasse 40 pièces en une partie », « Utilise le jetpack », « Atteins 1000 points »). Les accomplir toutes débloque un palier plus difficile. La progression est sauvegardée et s'affiche dans le menu.
...
- **Décor de jour** : ciel dégradé avec soleil et nuages, silhouette de ville colorée, herbe, trains de 6 couleurs.
...
src/missions.py    missions (objectifs par palier), logique pure
...
python -m pytest            # 23 tests : collisions, génération, bonus, jetpack, missions, sauvegarde
```
